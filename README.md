...
{
  "dependencies": {
    "@smartesting/gravity-data-collector": "^6.1.2"
  }
}
```
...
<script
  ...
  src="https://unpkg.com/@smartesting/gravity-data-collector@6.1.2/dist/gravity-logger-min.js"
></script>
```
...
| inlineResources        | Boolean                                                       | Inline style and images of the recorded snapshots. Set to `false` if you notice slowdowns with the collector.                                                                                                                                                | true                                |
