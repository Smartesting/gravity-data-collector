...
## [Unreleased](https://github.com/Smartesting/gravity-data-collector/compare/v4.0.0...main)

### Fixed

- catch exception `Uncaught ReferenceError: process is not defined` in method `discoverBuildId`

## [4.0.0](https://github.com/Smartesting/gravity-data-collector/compare/v4.0.0...main)
